...
\cventry{Mars 2016--Aujourd'hui}{Consultant en Logiciel Libre}{Savoir-Faire Linux}{Montréal}{}{
\begin{itemize}
\item Développement d'un framework d'échange de données entre différents objets connectés (C++ 11, ZeroMQ, Protobuf, ld, gcov)
\item Mis à jour du logiciel embarqué vers une nouvelle version (Yocto, systemd)
