...
> Savoir-faire Linux est une entreprise de consultants spécialisés dans le _Logiciel Libre_. Je fais parti de l'équipe Solution Industrielle qui est en charge de développer les \textit{Systèmes Embarqués Linux} qui équipent les objets connectés de nos clients.
